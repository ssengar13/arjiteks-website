...
<head>
    <meta charset="utf-8">
    <title>Verify your account | Unified Voice Communication</title>
    <link rel="stylesheet" type="text/css" href="assets1/css/otp.css" />
...
$otpInput = $_POST["one"] . $_POST["two"] . $_POST["three"] . $_POST["four"] . $_POST["five"];
...
if(!empty($otpInput))
{
    if($otp == $otpInput)
    {
        ...
        echo '<script>window.location.href = "Source/index.php";</script>';
...
<section>
  ...
  <div id='inputs'>
    <input id='input1' type='text' maxLength="1" name ="one" />
    <input id='input2' type='text' maxLength="1" name ="two" />
    <input id='input3' type='text' maxLength="1" name ="three"/>
    <input id='input4' type='text' maxLength="1" name ="four" />
    <input id='input5' type='text' maxLength="1" name ="five" />
  </div>
  <button>Submit</button>
  <div class="resend">Didn't receive code? <a href="" class="request" >Request again</a></div>
  </form>
</section>
</body>
