                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="para1" id="para1" placeholder="Add Description" required class="form-control"><?php echo $menu['para1']; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <!-- <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label for="para2">Paragraph 2<span class="required text-danger">*</span></label>
                                                                    <textarea name="para2" id="para2" placeholder="Add Description" required class="form-control"><?php echo $menu['para2']; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    <label for="subheading1">Subheading 1<span class="required text-danger">*</span></label>
                                                                    <input type="text" name="subheading1" value="<?php //echo $menu['subheading1']; 
                                                                                                                    ?>" id="subheading1" placeholder="Add Subheading" required class="form-control">
                                                                </div>
                                                            </div> -->
                                                            <!-- <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    <label for="sub_para1">Paragraph <span class="required text-danger">*</span></label>
                                                                    <textarea name="sub_para1" id="sub_para1" placeholder="Add Description" required class="form-control"><?php //echo $menu['sub_para1']; 
                                                                                                                                                                            ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    <label for="subheading2">Subheading 2<span class="required text-danger">*</span></label>
                                                                    <input type="text" name="subheading2" value="<?php //echo $menu['subheading2']; 
                                                                                                                    ?>" id="subheading2" placeholder="Add Subheading" required class="form-control">
                                                                </div>
                                                            </div> -->
                                                            <!-- <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    <label for="sub_para2">Paragraph <span class="required text-danger">*</span></label>
                                                                    <textarea name="sub_para2" id="sub_para2" placeholder="Add Description" required class="form-control"><?php //echo $menu['sub_para2']; 
                                                                                                                                                                            ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="bullets" id="bullets" placeholder="Add Description" required class="form-control"><? php // echo $menu['bullets']; 
                                                                                                                                                                        ?></textarea>
                                                                </div>
                                                            </div> -->
                                                            <div class="col-md-6">
                                                            ...
                                                            <!-- <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="conclusion" id="conclusion" placeholder="Add Description" required class="form-control"><?php echo $menu['conclusion']; ?></textarea>
                                                                </div>
                                                            </div> -->
                                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea name="para1" id="para1" placeholder="Add Description" required class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="para2">Paragraph 2<span class="required text-danger">*</span></label>
                                <textarea name="para2" id="para2" placeholder="Add Description" required class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="subheading1">Subheading 1<span class="required text-danger">*</span></label>
                                <input type="text" name="subheading1" id="subheading1" placeholder="Add Subheading" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="sub_para1">Paragraph <span class="required text-danger">*</span></label>
                                <textarea name="sub_para1" id="sub_para1" placeholder="Add Description" required class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="subheading2">Subheading 2<span class="required text-danger">*</span></label>
                                <input type="text" name="subheading2" id="subheading2" placeholder="Add Subheading" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="sub_para2">Paragraph <span class="required text-danger">*</span></label>
                                <textarea name="sub_para2" id="sub_para2" placeholder="Add Description" required class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="bullets">Bullets <span class="required text-danger">*</span></label>
                                <textarea name="bullets" id="bullets" placeholder="Add Description" required class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="conclusion">Conclusion<span class="required text-danger">*</span></label>
                                <textarea name="conclusion" id="conclusion" placeholder="Add Description" required class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                    <span class="text-muted ">(<span class="text-danger">*</span>) Fields are Required.</span>
